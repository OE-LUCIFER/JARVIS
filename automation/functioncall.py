"""
pip install --upgrade —no-catch-dir setuptools wheel

pip install -U --no-catch-dir webscout
---------------------or------------------
pip install --no-deps webscout
"""
...
class FunctionCallingAgent:
    def __init__(self, model: str = "GPT-4o", 
                 tools: list = None):
        self.ai = Julius(model=model, timeout=300, intro=None, filepath=None)
